                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                for(int i=0;i<js.length();i++)
                                {
                                    ...
                                    postid[i]=u.getString("ulid");
                                    post[i]=u.getString("name");
                                    date[i]=u.getString("email");



                                }
                                ls.setAdapter(new Custom_view_my_post(getApplicationContext(),postid,post,date));
