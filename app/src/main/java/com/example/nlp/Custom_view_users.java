...
public class Custom_view_users  extends BaseAdapter {
    ...
    public Custom_view_users(Context appcontext, String[]ulid,String[]uname,String[]uemail,String[]uimage,String[]status)
    {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        btsend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "http://" + hu + ":5000/and_send_friend_request";
...
//
        ...
        btcancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SharedPreferences sh = PreferenceManager.getDefaultSharedPreferences(context);
                String hu = sh.getString("ip", "");
                String url = "http://" + hu + ":5000/and_cancel_friend_request";
