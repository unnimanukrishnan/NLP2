...
public class Custom_view_my_post extends BaseAdapter {
    String[]postid;
    String[]post;
    String[]date;
    private Context context;
    public Custom_view_my_post(Context appcontext, String[]postid,String[]post,String[]date)
    {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            gridView = inflator.inflate(R.layout.custom_view_my_post, null);
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                        ...
                                        Intent i = new Intent(context, view_post.class);
