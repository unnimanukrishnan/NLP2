...
public class Custom_view_all_post extends BaseAdapter {
    String[]postid;
    String[]post;
    String[]date,name,image;
    private Context context;
    public Custom_view_all_post(Context appcontext, String[]postid,String[]post,String[]date,String[]name,String[]image)
    {
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                        ...
                                        Intent i = new Intent(context, View_all_post.class);
                                        i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                        context.startActivity(i);
